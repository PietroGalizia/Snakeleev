...
const diets = {
    "Critical elements": ["He", "Li", "B", "Mg", "P", "Sc", "V", "Cr", "Mn", "Co", "Ni", "Cu", "Zn", "Ga", "Ge", "As", "Se", "Sr", "Y", "Zr", "Nb", "Mo", "Ru", "Rh", "Pd", "Ag", "Cd", "In", "Sn", "Sb", "Te", "Nd", "Dy", "Hf", "Ta", "W", "Os", "Ir", "Pt", "Au", "Hg", "Tl", "Pb", "Bi"],
...
const dietMessages = {
    "Critical elements": [
        ...
        "'The 90 natural elements that make up everything. How much is there? Is that enough?'<br>Take a look on <a href='https://www.euchems.eu/wp-content/uploads/2018/10/Periodic-Table-ultimate-PDF.pdf' target='_blank' style='color: rgb(143, 125, 207);'>EuChemS Periodic Table – 2.0 2023 version</a>",
        "Not all elements are in plentiful supply. Many are at serious risk over the next 100 years, others are becoming increasingly threatened due to rising demand, and several currently considered to have limited availability may face future supply risks. Discover how element scarcity has changed from 2019 to 2023. <br>Take a look on <a href='https://www.euchems.eu/euchems-periodic-table/' target='_blank' style='color: rgb(143, 125, 207);'>EuChemS Periodic Tables</a>"
    ],
